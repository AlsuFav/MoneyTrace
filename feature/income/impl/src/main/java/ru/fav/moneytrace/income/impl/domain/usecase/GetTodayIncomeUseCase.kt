...
/**
 * Use case для получения доходов за текущий день.
 *
 * Загружает транзакции основного счета за сегодняшний день, фильтрует только доходы
 * (исключая расходы) и сортирует их по времени в убывающем порядке.
 *
